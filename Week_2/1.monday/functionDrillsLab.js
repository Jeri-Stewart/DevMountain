...
const upperString = (str) => console.log(str.toUpperCase());
...
function goldForFrogs(gold) {
  let frog = 3;
  let total = gold / frog;
  return total;
}

let totalFrogs = goldForFrogs(25);
...
function goldForFrogs2(gold) {
  let frog = 3;
  let total = gold / frog;
  return Math.floor(total);
}

let totalFrogs2 = goldForFrogs2(25);
