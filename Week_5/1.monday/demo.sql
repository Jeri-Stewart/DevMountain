...
-- rank functions: https://www.sqlshack.com/overview-of-sql-rank-functions/
/*
wrote queries in the website link.
Since the queries disappear after refresh, wrote queries here
*/
...
-- code form discord to isnert more values
