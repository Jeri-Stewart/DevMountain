...
// 1. Create a variable for Jon and Jamie’s attack strengths.
...
/* 
2. Before the battle begins, Jon and Jamie decide to compare attack
 strengths to get insight into who might win this battle. Using an if-else statement,
...
/*
5. Jamie attacks first - use an if/else to determine if Jon Snow can survive the attack. If he does not,
 console.log “Jon Snow has been slain.” Otherwise, condole.log Jon Snow’s health.
*/
...
/*
6. Jon Snow, adamant he does not want to fight Jamie (can you blame him?), 
...
/*
7. Jamie attacks again - use an if/else to determine if Jon Snow can survive the attack.
 Make sure to account for Jon’s defense.
 If he does not, console.log “Jon Snow has been slain.” 
...
and if the coin lands on heads, he will aim to take Jon’s head.
 If it lands on tails, Jamie will allow Jon to run away. Create a variable called 
 coinLandsHeads and set it equal to false. Then, using an if-else statement 
 and the equality operator, handle the value of the flipped coin 
...
/*
12. Now we will combine for loops and if statements. 
Add a condition to check if Jon Snow will survive
*/
...
/*
13. Now we will combine for loops and if statements. 
Add a condition to check if Jon Snow will survive
*/
