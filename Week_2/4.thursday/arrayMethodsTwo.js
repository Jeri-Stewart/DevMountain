...
/* 
    Use a built-in Javascript method that will loop through the 'numbers' array above, 
    divide each number by 2, and then return a NEW ARRAY.

    HINT: .forEach() vs .map() ---- which one does return a new array?

    NOTE: make sure you save the code in a variable,
     then console.log the variable to see the new array.
*/
...
/* 
    Use the filter method on 'cities' array to return a new array of city/cities that 
    end(s) with letter "i."

    Make sure you save the code in a variable.
     Then, console.log the variable to see the new array.
*/

// CODE HERE

let iCities = cities.filter((city) => city.charAt(city.length - 1) === "i");
