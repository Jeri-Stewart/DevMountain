...
//CODE HERE
let codingLanguage = ["javascript", "python", "java", "c++"];
/* 
...
let codingLanguage3 = codingLanguage.slice(); //copies the entire array with inputing aruguments
/* 
...
let instruments2 = instruments.splice(2, 1);
